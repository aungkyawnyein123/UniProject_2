<?php
	...
	$select="SELECT * FROM users_data
			WHERE UserID='$UserID'";
	$select="SELECT users_data.UserID, users_data.FullName, users_data.User_email, department_data.DepartmentName, users_data.PhoneNo, users_data.Address FROM users_data 
                        INNER JOIN department_data ON department_data.DepartmentID=users_data.DepartmentID
			WHERE UserID='$UserID'";
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">View Staff</h4>
			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							<span class="k">Staff Details</span>
						...
						<div class="widget-inner">
							...
							<form class="edit-profile m-b30" action="" method="POST">
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" type="text" name="departmentname" value="<?= $callvalue['UserID'] ?>" disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Full Name</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="departmentname" value="<?= $callvalue['FullName'] ?>" disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">SEmail</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="departmentname" value="<?= $callvalue['User_email'] ?>" disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Department</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="departmentname" value="<?= $callvalue['DepartmentName'] ?>" disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Phonne</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="departmentname" value="<?= $callvalue['PhoneNo'] ?>" disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Address</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="phone"value="<?= $callvalue['Address'] ?>" disabled>
										</div>
									</div>
									<div class="row">
									<div class="col-sm-2">
									...
									<div class="col-sm-7">
										<input type="button" class="btn-secondry" name="back" onclick="history.back();" value="Back">
									</div>
								</div>
							</form>
