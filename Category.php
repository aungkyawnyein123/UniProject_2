							...
							<table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<?php echo '<a class="btn btn-icon btn-sm" href="CategoryEdit.php?CategoryID='. $row->CategoryID.'"><i class="fa fa-edit"></i></a>';?>
                                                
                                                <?php echo '<a class="btn btn-icon btn-sm js-sweetalert" onclick="return confirm(\'Confirm Delete?\')" href="CategoryDelete.php?CategoryID='. $row->CategoryID.'"><i class="fa fa-trash-o text-danger"></i></a>';?></td>
                                        </tr>
                                        <?php } ?>
