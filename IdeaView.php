...
$select3="SELECT idea_data.IdeaID, idea_data.Annoymous, users_data.FullName, idea_data.Idea_title, categories_data.CategoryName, idea_data.View FROM idea_data 
        ...
        WHERE ClosureID='$ClosureID' ORDER BY View DESC LIMIT $offset, $no_of_records_per_page";
...
<div><br>
    ...
    <a href="IdeaLatest.php?ClosureID=<?php echo $ClosureID;?>" class="btn">New-Old Ideas</a>
</div><br>
