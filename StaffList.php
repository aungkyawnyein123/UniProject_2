<?php
	include("connect.php");
	$select="SELECT * FROM users_data WHERE RoleID=4";
							...
							<table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<?php echo '<a class="btn btn-icon btn-sm" href="StaffView.php?UserID='. $row->UserID.'"><i class="fa fa-eye"></i></a>';?>
                                            </td>
                                        </tr>
                                        <?php } ?>
