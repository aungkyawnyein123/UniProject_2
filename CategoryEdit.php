			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							<span class="k">Edit Categories</span>
						...
						<div class="widget-inner">
							...
							<form class="edit-profile m-b30" action="" method="POST">
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" type="text" id="name" name="CategoryName" placeholder="Edit Category" value="<?= $callvalue['CategoryName'] ?>">
										</div>
									</div>
									<div class="row">
									<div class="col-sm-2">
